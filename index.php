...
<section id="top-sale">
  <div class="container py-5">
    ...
    while ($store = $toko_result->fetch_assoc()) {
        ...
        echo '</div><br>'; // tutup owl-carousel
    }
    ?>
  </div>
</section>
              ...
              <!-- owl carousel -->
                <div class="owl-carousel owl-theme">
                  <div class="item py-2">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                      <a href="#"><img src="../assets/products/adidas/ad1.jpg" alt="product1" class="img-fluid"></a>
                      <div class="text-center">
                        <h6>Adidas UltraBoost Light</h6>
                        <div class="rating text-warning font-size-12">
                  ...
                  <div class="item py-2">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                      <a href="#"><img src="./assets/products/adidas/ad2.jpg" alt="product1" class="img-fluid"></a>
                      <div class="text-center">
                        <h6>Adidas Superstar 360</h6>
                        <div class="rating text-warning font-size-12">
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                  ...
                  <div class="item py-2">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                      <a href="#"><img src="./assets/products/adidas/ad3.jpg" alt="product1" class="img-fluid"></a>
                      <div class="text-center">
                        <h6>Adidas Superstar II</h6>
                        <div class="rating text-warning font-size-12">
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                  ...
                  <div class="item py-2">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                      <a href="#"><img src="./assets/products/nike/nk1.png"  alt="product1" class="img-fluid"></a>
                      <div class="text-center">
                        <h6>Nike Blazer Mid</h6>
                        <div class="rating text-warning font-size-12">
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                  ...
                  <div class="item py-2">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                      <a href="#"><img src="./assets/products/adidas/ad4.jpg" alt="product1" class="img-fluid"></a>
                      <div class="text-center">
                        <h6>AdidasUltraBoost 1.0 Fortnite</h6>
                        <div class="rating text-warning font-size-12">
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                          <span><i class="fas fa-star"></i></span>
                  ...
                  <div class="item py-2">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                        <a href="#"><img src="./assets/products/adidas/ad5.jpg" class="img-fluid" alt="pro1"></a>
                        <div class="text-center">
                          <h6>Adidas Superstar X Minecraft</h6>
                          <div class="rating text-warning font-size-12">
                            <span><i class="fas fa-star"></i></span>
                            <span><i class="fas fa-star"></i></span>
                            <span><i class="fas fa-star"></i></span>
                  ...
                  <div class="item py-2">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                        <a href="#"><img src="./assets/products/nike/nk2.png" class="img-fluid" alt="pro1"></a>
                        <div class="text-center">
                          <h6>Readme Note 7</h6>
                          <div class="rating text-warning font-size-12">
                            <span><i class="fas fa-star"></i></span>
          ...
          <section id="special-price">
            <div class="container">
              ...
              <div id="filters" class="button-group text-right font-baloo font-size-16">
                ...
                <button class="btn" data-filter=".new-balence">New Balence</button>
              </div>
              ...
              <div class="grid">
                ...
                <div class="grid-item  nike border">
                  <div class="item py-2" style="width: 200px;">
                   <div class="product font-rale">
                     <a href="#"><img src="./assets/products/nike/nk1.png" alt="product1" class="img-fluid"></a>
                     <div class="text-center">
                 ...
                 <div class="grid-item  new-balence border">
                  <div class="item py-2" style="width: 200px;">
                   <div class="product font-rale">
                     <a href="#"><img src="./assets/products/newbalance/nb1.jpg" alt="product1" class="img-fluid"></a>
                     <div class="text-center">
                       <h6>New Balence</h6>
                       <div class="rating text-warning font-size-12">
                         <span><i class="fas fa-star"></i></span>
                 ...
                 <div class="grid-item  nike border">
                  <div class="item py-2" style="width: 200px;">
                   <div class="product font-rale">
                     <a href="#"><img src="./assets/products/nike/nk2.png" alt="product1" class="img-fluid"></a>
                     <div class="text-center">
                       <h6>Nike</h6>
                       <div class="rating text-warning font-size-12">
                         <span><i class="fas fa-star"></i></span>
                 ...
                 <div class="grid-item  new-balence border ">
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                        <a href="#"><img src="./assets/products/newbalance/nb2.jpg" class="img-fluid" alt="pro1"></a>
                        <div class="text-center">
                          <h6>New Balence</h6>
                          <div class="rating text-warning font-size-12">
                            <span><i class="fas fa-star"></i></span>
                ...
                <div class="grid-item adidas border ">
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                        <a href="#"><img src="./assets/products/adidas/ad3.jpg" class="img-fluid" alt="pro1"></a>
                        <div class="text-center">
                          <h6>Adidas</h6>
                          <div class="rating text-warning font-size-12">
                            <span><i class="fas fa-star"></i></span>
                ...
                <div class="grid-item  nike border ">
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                        <a href="#"><img src="./assets/products/nike/nk3.png" class="img-fluid" alt="pro1"></a>
                        <div class="text-center">
                          <h6>Nike</h6>
                          <div class="rating text-warning font-size-12">
                            <span><i class="fas fa-star"></i></span>
                ...
                <div class="grid-item  new-balence border">
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                        <a href="#"><img src="./assets/products/newbalance/nb3.jpg" class="img-fluid" alt="pro1"></a>
                        <div class="text-center">
                          <h6>New Balence</h6>
                          <div class="rating text-warning font-size-12">
                            <span><i class="fas fa-star"></i></span>
                ...
                <div class="grid-item adidas border  " >
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                        <a href="#"><img src="./assets/products/adidas/ad4.jpg" class="img-fluid" alt="pro1"></a>
                        <div class="text-center">
                          <h6>Adidas</h6>
                          <div class="rating text-warning font-size-12">
                            <span><i class="fas fa-star"></i></span>
